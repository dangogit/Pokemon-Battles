PokemonsBattles‬‬‬‬: MainSecond.o Pokemon.o BattleByCategory.o LinkedList.o MaxHeap.o
	gcc MainSecond.o Pokemon.o BattleByCategory.o LinkedList.o MaxHeap.o -o PokemonsBattles
